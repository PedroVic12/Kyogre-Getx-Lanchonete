...
class AnimatedProductCardWrapper extends StatefulWidget {
  ...
  @override
  _AnimatedProductCardWrapperState createState() => _AnimatedProductCardWrapperState();
}
...
class AnimatedProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      transform: Matrix4.translationValues(startOffsetX * MediaQuery.of(context).size.width, 0, 0),
      child: InkWell(
        onTap: onTap,
        child: Container(
